...
`environment` | [CheckoutSessionGetEnvironment](CheckoutSessionGetEnvironment.md)
...
```typescript
import type { CheckoutSessionGet } from '@moosyl/sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as CheckoutSessionGet
