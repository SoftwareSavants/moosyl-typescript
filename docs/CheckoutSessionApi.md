...
| [**postCheckoutSessionPublicByIdSimulateTransfer**](CheckoutSessionApi.md#postcheckoutsessionpublicbyidsimulatetransferoperation) | **POST** /checkout-session/public/{id}/simulate-transfer | Simulate a Gimtel transfer (sandbox) |
...
import type { GetCheckoutSessionPublicByIdPaymentStatusRequest } from '@moosyl/sdk';
...
async function example() {
  ...
  } satisfies GetCheckoutSessionPublicByIdPaymentStatusRequest;

  try {
    const data = await api.getCheckoutSessionPublicByIdPaymentStatus(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { PostCheckoutSessionPublicByIdSimulateTransferOperationRequest } from '@moosyl/sdk';
...
async function example() {
  ...
  const body = {
    ...
    postCheckoutSessionPublicByIdSimulateTransferRequest: ...,
  } satisfies PostCheckoutSessionPublicByIdSimulateTransferOperationRequest;

  try {
    const data = await api.postCheckoutSessionPublicByIdSimulateTransfer(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
